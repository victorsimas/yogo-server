...
namespace YogoServer.UnitTests.Methods
{
    public class ExecuteAsyncDeve
    {
        ...
        public async void EmailsDefineAsync()
        {
            ...
            Emails emails = await inboxRequest.ExecuteAsync(listEmailForTest);
        ...
        public async void EmailDefineAsync()
        {
            ...
            Email email = await inboxRequest.ExecuteAsync(showEmailForTest);
